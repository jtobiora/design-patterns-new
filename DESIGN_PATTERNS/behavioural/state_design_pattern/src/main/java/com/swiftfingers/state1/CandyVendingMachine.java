...
/*
* In the CandyVendingMachine class that we wrote above, we defined instance variables for all the four states. In
* addition we have an instance variable state that will hold the current state of the machine and count that
* represents the number of candies available in the machine. In the constructor we initialized all the instance
* variables.
*
* */
